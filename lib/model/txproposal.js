...
TxProposal.prototype._buildTx = function() {
  ...
  // Validate actual inputs vs outputs independently of Mangacore
...
TxProposal.prototype.getMangacoreTx = function() {
  var self = this;
  ...
  _.each(sigs, function(x) {
    self._addSignaturesToMangacoreTx(t, x.signatures, x.xpub);
  });
...
TxProposal.prototype._addSignaturesToMangacoreTx = function(tx, signatures, xpub) {
  var self = this;
...
TxProposal.prototype.sign = function(copayerId, signatures, xpub) {
  try {
    ...
    var tx = this.getMangacoreTx();
    this._addSignaturesToMangacoreTx(tx, signatures, xpub);
