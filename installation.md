...
```bash
npm install mangacore-wallet-service
...
```
### Configuration
Configuration for all required modules can be specified in https://github.com/bitpay/mangacore-wallet-service/blob/master/config.js
...
Mangacore Wallet Service - bws.js
